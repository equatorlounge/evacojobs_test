            ...
            <div class="col-lg-8 col-12 mb-5 pr-lg-5">
                ...
                <div class="company-list-wrap row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12">
                        <a href="company-single.php" class="company-list">
                            <span class="company-logo"><img src="assets/images/companies/company-1.png"
                                    alt="company-1"></span>
                            <h6 class="title">Envato</h6>
                            <span class="open-job">1 open position</span>
                            <span class="location"><i class="fa fa-map-o"></i>Melbourne, Aus</span>
                        </a>
                    </div>
                    <!-- Company List End -->
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12">
                        <a href="company-single.php" class="company-list">
                            <span class="company-logo"><img src="assets/images/companies/company-11.png"
                                    alt="company-span"></span>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12">
                        <a href="company-single.php" class="company-list">
                            <span class="company-logo"><img src="assets/images/companies/company-12.png"
                                    alt="company-span"></span>
